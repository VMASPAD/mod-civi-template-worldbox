...
// Archivo de carga de Tab (pestaña que aparece al lado de las pestañas default del juego)
namespace MoreRaces
{
    class MoreRacesTab
    {
        ...
        public static void createTab(string buttonID, string tabID, string name, string desc, int xPos)
        {
            ...
            if (OtherTabButton != null)
            {
                ...
                Localization.AddOrSet("DiogoMoreRaces_mod_creator",  "Made By: Diogo"); // Solo modificar aqui
                ...
                tipButton.text_description_2 = "DiogoMoreRaces_mod_creator";



                newTabButton.transform.localPosition = new Vector3(200f, 49.57f);
                newTabButton.transform.localScale = new Vector3(1f, 1f);
                newTabButton.name = buttonID;

                var spriteForTab = Resources.Load<Sprite>("ui/Icons/tabIconMoreRaces");
